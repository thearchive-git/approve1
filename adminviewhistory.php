...
if (isset($_GET['_id']) && filter_var($_GET['_id'], FILTER_VALIDATE_INT)) {
    ...
    if (isset($_POST['approve'])) {
        ...
        $insertSql = "INSERT INTO approved_claim_reports 
        ...
        if ($insertStmt->execute()) {
            ...
            $deleteSql = "DELETE FROM approved_claim_reports WHERE id = ?";
            ...
            header("Location: approved_claim_report.php");
            exit;
        } else {
    ...
    <div class="container-wrapper">
        ...
        <div class="container">
            ...
            <div class="btn-container">
                <a href="approved_claim_report.php" class="btn btn-back">Back</a>
                <form method="POST">
