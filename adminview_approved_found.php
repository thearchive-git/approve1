        ...
        <div class="container-wrapper">
            <div class="container">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="item_name" id="item_name"
                            value="<?= isset($item['item_name']) ? htmlspecialchars($item['item_name']) : 'N/A' ?>" 
                            class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label for="date_found">Date Lost</label>
                        <input type="date" name="date_found" id="date_found"
                            value="<?= isset($item['date_found']) ? htmlspecialchars($item['date_found']) : '' ?>" 
                            class="form-control" readonly>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="category" id="category"
                            value="<?= isset($item['category']) ? htmlspecialchars($item['category']) : 'N/A' ?>" 
                            class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label for="time_found">Time Lost</label>
                        <input type="time" name="time_found" id="time_found"
                            value="<?= isset($item['time_found']) ? htmlspecialchars($item['time_found']) : '' ?>" 
                            class="form-control" readonly>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <hr>
                    <img src="<?= !empty($item["picture"]) ? htmlspecialchars($item["picture"]) : 'images/placeholder.png' ?>" 
